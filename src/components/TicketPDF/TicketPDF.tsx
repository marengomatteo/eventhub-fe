            ...
            <Page size="A4" style={styles.page}>
                <View style={styles.container}>
                    ...
                    <View style={styles.header}>
                        <Image src={Logo} style={{ height: 40, width: 100, objectFit: 'contain' }} />
                    </View>
                    ...
                    {biglietto.imageUrl ? (
                        ...
                        <Text style={{ color: '#8795a4', textAlign: 'center', marginBottom: 8 }}>
                    ...
                    <View style={styles.eventDetails}>
                        ...
                        <View style={styles.locationContainer}>
                            ...
                            {mapUrl ? (
                                ...
                                <Text style={{ color: '#8795a4', textAlign: 'center' }}>Mappa non disponibile</Text>
                            )}
                        </View>
                    ...
                    {/* Footer */}
                    <Text style={styles.footer}>Presenta questo biglietto all'ingresso</Text>
                </View>
            </Page>
        </Document>
    );
